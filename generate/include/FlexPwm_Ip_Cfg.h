...
#include "FlexPwm_Ip_VS_0_PBcfg.h"
...
#define FLEXPWM_IP_DEV_ERROR_DETECT            (STD_ON)

/** @brief    Support for User mode */
#define FLEXPWM_IP_ENABLE_USER_MODE_SUPPORT    (STD_OFF)

/** @brief      The number of FlexPwm instances available on platform */
#define FLEXPWM_IP_INSTANCE_COUNT_U8           (uint8)(2U)
/** @brief      The number of channels available on each FlexPwm instance */
#define FLEXPWM_IP_SUBMODULE_COUNT_U8          (uint8)(4U)

#define FLEXPWM_IP_NUMCHANNELS_PER_SUBMODULE_U8   (uint8)(3U)
